...
local my_language = {
	...
	payday_message = "Pay day!คุณได้รับเงิน %s!",
	...
	health = "พลังชีวิต: %s",
	job = "อาชีพ: %s",
	salary = "เงินเดือน: %s%s",
	wallet = "กระเป๋าเงิน: %s%s",
	weapon = "อาวุธ: %s",
	kills = "ฆ่า: %s",
	deaths = "ตาย: %s",
	...
	name = "ชื่อ: %s",
	locked = "มันล็อคอยู่.",
	unlocked = "เปิดได้แล้ว.",
	player_doesnt_exist = "ไม่สามารภออกได้.",
	job_doesnt_exist = "ไม่สามารถเปลี่ยนอาชีพได้!",
